...
module.exports = function(gulpTasksOptions) {
    ...
    var ifTestsExistsFor = function(component, testRunner) {
    ...
    var defineTestTasks = function(component) {
        ...
        gulp.task(component + ':test', ['clean', 'bower'], function(done) {
            ifTestsExistsFor(component, function() {
                ...
                new karma.Server(karmaServerOptions, function(exitCode) {
                    ...
                    if (exitCode !== 0) { // Ensure not set process exitCode on success. Else it will override failure in other task
    ...
    gulp.task('default', ['lint', 'test', 'dist', 'doc']);
}
